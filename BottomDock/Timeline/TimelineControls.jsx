    ...
    render() {
        return (
            <div className={Styles.controls}>
                <button type='button' className={Styles.timelineControl} onClick={this.gotoStart} title="返回至起点">
                    <Icon glyph={Icon.GLYPHS.backToStart}/>
                </button>
                <button type='button' className={Styles.timelineControl} onClick={this.togglePlay} title="播放">
                    {this.isPlaying() ? <Icon glyph={Icon.GLYPHS.pause}/> : <Icon glyph={Icon.GLYPHS.play}/>}
                </button>
                <button type='button' className={Styles.timelineControl} onClick={this.playSlower} title="快退">
                    <Icon glyph={Icon.GLYPHS.backward}/>
                </button>
                <button type='button' className={Styles.timelineControl} onClick={this.playFaster} title="快进">
