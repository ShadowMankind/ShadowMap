            ...
            <div className={Styles.tabPanels}>
                <If condition={this.state.activeTab === 'local'}>
                    <section className={Styles.tabPanel}>
                        <label className={Styles.label}><strong>第一步:</strong> 选择添加的文件类型: </label>
                        ...
                        <label className={Styles.label}><strong>第二步:</strong> 选择本地数据文件添加:
                        </label>
                ...
                <If condition={this.state.activeTab === 'web'}>
                    <section className={Styles.tabPanel}>
                        ...
                        <label className={Styles.label}><strong>第二步:</strong> 输入数据文件或网络服务链接:
                        </label>
                        <form className={Styles.urlInput}>
                            <input value={this.state.remoteUrl} onChange={this.onRemoteUrlChange}
                                   ...
                                   type='text'
                                   placeholder='e.g. http://19.111.158.147:8088/geoserver/MC/wms'/>
