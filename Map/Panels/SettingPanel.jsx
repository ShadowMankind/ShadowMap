...
const SettingPanel = createReactClass({
    ...
    render() {
        ...
        if (this.props.terria.configParameters.useCesiumIonTerrain || this.props.terria.configParameters.cesiumTerrainUrl) {
            viewerModes.push('3D地形');
        }

        viewerModes.push('3D', '2D');

        return (
            <MenuPanel theme={dropdownTheme} btnTitle="改变视图" btnText="地图" viewState={this.props.viewState}
                       smallScreen={this.props.viewState.useSmallScreenInterface}>
                <div className={classNames(Styles.viewer, DropdownStyles.section)}>
                    <label className={DropdownStyles.heading}>地图视角</label>
