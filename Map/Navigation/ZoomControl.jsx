        ...
        return (
            <div className={Styles.zoomControl}>
                <ul className={Styles.list}>
                    <li>
                        <button type='button' onClick={this.zoomIn} className={Styles.increase} title='放大'>
                            <Icon glyph={Icon.GLYPHS.increase}/>
                        </button>
                    </li>
                    <li>
                        <button type='button' onClick={this.zoomReset} className={Styles.refresh} title='初始范围'>
                            <Icon glyph={Icon.GLYPHS.refresh}/>
                        </button>
                    </li>
                    <li>
                        <button type='button' onClick={this.zoomOut} className={Styles.decrease} title='缩小'>
